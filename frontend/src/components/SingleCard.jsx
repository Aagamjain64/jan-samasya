...
const SingleCard = ({
  ...
  const getStatusBadgeClass = (problemStatus) => {
  ...
  return (
    <div className="card h-100 shadow-sm">
      <div className="card-poster-bar">
        <span className="card-poster-label">Posted by</span>
        <span className="card-poster-name">
          {postedByisAnonymous ? 'Anonymous' : postedByUsername || 'Unknown user'}
        </span>
      </div>
...
/>
      ...
      <div className="card-body text-center">
        ...
        <span className={`badge ${getStatusBadgeClass(status || 'Pending')} mb-2`}>
          {status || 'Pending'}
        </span>
